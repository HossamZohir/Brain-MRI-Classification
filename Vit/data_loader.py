...
# === CONFIG START ===
DATA_DIR = "F:/hossam/work papers/drowsiness/dataset"
BATCH_SIZE = 32
NUM_WORKERS = 4
IMAGE_SIZE = 224  # ViT-B/16 expects 224x224 input
# === CONFIG END ===
...
def get_data_loaders():
    ...
    val_test_transforms = transforms.Compose([
        transforms.Resize(IMAGE_SIZE + 32),  # Resize to 256 then crop to 224
